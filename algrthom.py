...
def main():
    ...
    json_path = r"C:\Users\user\Desktop\vscode project\CRW4_DataProcess\CRW4_data\json\SDS_911058_001_20251021_example_100.json"
    ...
    # A.json, B.json, ...
    output_base = r"C:\Users\user\Desktop\vscode project\CRW4_DataProcess\CRW4_data\success_cas_json_for_algo_test\\"
        ...
        for sub_label_A, sub_group_A in subs_A.items():
            for sub_label_B, sub_group_B in subs_B.items():
                ...
                if(should_skip(combine_sub_label_name, done)):
                    print(f"[SKIP] 組間 {f"{combine_sub_label_name}"}（已完成）")
                    continue
